package com.popkter.poputils.threadinteraction
...
class DataStreamHelper: CoroutineScope by CoroutineScope(Dispatchers.IO + SupervisorJob()) {

    companion object {
        private const val TAG = "DataFlow"
        val instance by lazy(LazyThreadSafetyMode.SYNCHRONIZED) { DataStreamHelper() }
    }
